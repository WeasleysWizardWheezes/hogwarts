...
public class EquipmentCategoryService {
    ...
    public Page<EquipmentCategory> getAll(int page, int size, String search) {
        ...
        if (search != null && !search.isBlank()) {
            return this.equipmentCategoryRepository
                    .findByNameContainingIgnoreCaseAndArchivedFalse(search, pageable);
        }
        return this.equipmentCategoryRepository.findByArchivedFalse(pageable);
    }
    ...
    public EquipmentCategory update(UUID categoryId, String name, String description) {
        ...
        if (name != null && !name.isBlank()) {
            boolean nameConflict = this.equipmentCategoryRepository
