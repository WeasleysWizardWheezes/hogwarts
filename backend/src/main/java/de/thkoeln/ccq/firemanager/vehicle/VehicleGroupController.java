...
import de.thkoeln.ccq.firemanager.vehicle.dto.CreateVehicleGroupRequest;
import de.thkoeln.ccq.firemanager.vehicle.dto.UpdateVehicleGroupRequest;
...
public class VehicleGroupController {
    ...
    public ResponseEntity<VehicleGroup> createVehicleGroup(
        ...
        var vehicleGroup = vehicleGroupService.create(request.name(), request.description());
    ...
    public ResponseEntity<VehicleGroup> updateVehicleGroup(
        ...
        var updatedGroup = vehicleGroupService.update(vehicleGroupId, request.name(), request.description());
    ...
    @GetMapping("/search")
    public ResponseEntity<List<VehicleGroup>> searchByName(String name) {
        var vehicleGroups = vehicleGroupService.searchByName(name);
