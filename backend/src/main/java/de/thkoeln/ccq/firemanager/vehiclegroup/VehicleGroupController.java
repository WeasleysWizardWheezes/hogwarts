...
public class VehicleGroupController {
    ...
    public ResponseEntity<VehicleGroup> createVehicleGroup(
        ...
        var vehicleGroup = vehicleGroupService.create(request.name(), request.beschreibung());
    ...
    public ResponseEntity<VehicleGroup> updateVehicleGroup(
        ...
        var updatedGroup = vehicleGroupService.update(vehicleGroupId, request.name(), request.beschreibung());
