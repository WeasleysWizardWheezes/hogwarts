...
import { LayoutDashboard, FolderOpen, Truck, Flame, Package, Tag } from "lucide-react"
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const navigationItems = [
  ...
  { title: "Geräte", url: "/equipment", icon: Package },
  { title: "Gerätekategorien", url: "/equipment-categories", icon: Tag },
]
