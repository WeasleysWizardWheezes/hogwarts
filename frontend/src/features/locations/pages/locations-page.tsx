...
import type { LocationResponse, CreateLocationRequest, UpdateLocationRequest } from "../api/locations-api"
...
export default function LocationsPage() {
  ...
  async function handleSubmit() {
    if (editing) {
      await updateMutation.mutateAsync({ locationId: editing.id!, body: formState as UpdateLocationRequest })
    } else {
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Select
                ...
                onValueChange={(value) => {
                  if (value) setFormState((prev) => ({ ...prev, type: value }))
                }}
              >
